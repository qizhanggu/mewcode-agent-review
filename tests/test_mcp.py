...
class TestMCPToolWrapper:
    def test_name_format(self) -> None:
        ...
        from localdesk.mcp.tool_wrapper import MCPToolWrapper
        from localdesk.mcp.client import MCPClient
...
class TestExtractText:
    def test_text_content(self) -> None:
        from mcp import types as mcp_types
        from localdesk.mcp.tool_wrapper import _extract_text
...
class TestMCPManagerPartialFailure:
    ...
    async def test_single_server_failure_does_not_block_others(self) -> None:
        from localdesk.mcp.manager import MCPManager
        ...
        with patch("localdesk.mcp.manager.MCPClient") as MockClient:
