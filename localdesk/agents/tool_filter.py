...
def build_teammate_tools(
    ...
    from localdesk.tools.send_message import SendMessageTool
    from localdesk.tools.task_create import TaskCreateTool
    from localdesk.tools.task_get import TaskGetTool
    from localdesk.tools.task_list import TaskListTool
    from localdesk.tools.task_update import TaskUpdateTool
...
def clone_registry_for_fork(parent_registry: ToolRegistry) -> ToolRegistry:
    ...
    from localdesk.tools.agent_tool import FORK_QUERY_SOURCE
