...
PROJECT_AGENTS_DIR = ".localdesk/agents"
USER_AGENTS_DIR = "~/.localdesk/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("localdesk.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from localdesk.agents.parser import parse_frontmatter, _validate_agent_meta
