...
if TYPE_CHECKING:
    from localdesk.agent import Agent
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from localdesk.agents.fork import ForkError, build_forked_messages
        from localdesk.agents.parser import AgentDef
        from localdesk.agents.tool_filter import clone_registry_for_fork, resolve_agent_tools
        from localdesk.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from localdesk.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from localdesk.agents.fork import ForkError, build_forked_messages
        from localdesk.agents.parser import AgentDef
        from localdesk.agents.tool_filter import build_teammate_tools
        from localdesk.agent import Agent as AgentClass
        from localdesk.conversation import ConversationManager
        from localdesk.permissions import (
            DangerousCommandDetector,
        ...
        from localdesk.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from localdesk.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from localdesk.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from localdesk.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from localdesk.config import ProviderConfig
