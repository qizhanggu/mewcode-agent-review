...
from localdesk.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from localdesk.tools.bash import Bash
    from localdesk.tools.edit_file import EditFile
    from localdesk.tools.file_state_cache import FileStateCache
    from localdesk.tools.glob import Glob
    from localdesk.tools.grep import Grep
    from localdesk.tools.read_file import ReadFile
    from localdesk.tools.write_file import WriteFile
