...
from localdesk.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from localdesk.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from localdesk.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
