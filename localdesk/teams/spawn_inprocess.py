...
from localdesk.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from localdesk.agent import Agent
    from localdesk.conversation import ConversationManager
    from localdesk.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from localdesk.conversation import ConversationManager as CM
                conv = CM()
