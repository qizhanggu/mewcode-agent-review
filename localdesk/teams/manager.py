...
from localdesk.teams.backend_detect import BackendDetectionError, detect_backend
from localdesk.teams.mailbox import Mailbox, create_message
...
from localdesk.teams.progress import TeammateProgress
from localdesk.teams.registry import AgentNameRegistry
from localdesk.teams.shared_task import SharedTaskStore
from localdesk.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from localdesk.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
